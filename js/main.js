...
(function(html) {
    ...
    const cfg = {
        ...
        finalDate : 'January 12, 2025 00:00:00',
        // MailChimp URL
        mailChimpURL : 'https://gmail.us17.list-manage.com/subscribe/post?u=154a8fde89998d4551ed05798&amp;id=112453fd17&amp;f_id=00c20ce0f0' 
    ...
    * ---------------------------------------------------- */ 
    const ssMailChimpForm = function() {
        ...
        function submitMailChimpForm(form) {
            ...
            window.mcStatus.innerText = 'A submeter...';
    ...
    * ---------------------------------------------------- */ 
    const sstabs = function(nextTab = false) {
        ...
        const tabClickEvent = function(tabLink, tabLinks, tabPanels, linkIndex, e) {
            ...
            console.log(tabLink.innerText === "SERVICES");
            switch(tabLink.innerText){
                case 'SERVICES':
                    document.querySelector('.s-info__bg').style.backgroundImage = "url(https://storage.googleapis.com/eco-lar-bucket/atlier/IMG_099.jpg)";
                    break;
                case 'ABOUT':
                    document.querySelector('.s-info__bg').style.backgroundImage = "url(https://storage.googleapis.com/eco-lar-bucket/Staff/equipas/IMG_171.jpg)";
                    break;
                case 'PROJECTS':
                    document.querySelector('.s-info__bg').style.backgroundImage = "url(https://storage.googleapis.com/eco-lar-bucket/golf%2019_17%20-%20Foto.jpg)";
                    break;
            }
            document.querySelector('.s-info__bg').style.backgroundRepeat = "no-repeat";
            document.querySelector('.s-info__bg').style.backgroundPosition = "center";
            document.querySelector('.s-info__bg').style.backgroundSize = "cover";
            document.querySelector('.s-info__bg').style.opacity = "0.4";
            document.querySelector('.s-info__bg').style.filter = "grayscale(80%)";
